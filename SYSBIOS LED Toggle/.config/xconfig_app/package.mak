...
app.xem4f: package/cfg/app_pem4f.oem4f 
	...
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/app_pem4f.oem4f   package/cfg/app_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map  -l $(ti.targets.arm.elf.M4F.rootDir)/lib/rtsv7M4_T_le_v4SPD16_eabi.lib
